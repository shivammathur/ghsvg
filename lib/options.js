...
program
    ...
    .option('--siw, --svg-image-width [svgImageWidth]', 'width of each image in the svg', parseFloat)
    .option('--sis, --svg-image-space [svgImageSpace]', 'space between each image in the svg', parseFloat)
...
export function getOptions(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const svgImageWidth = cliOpts.svgImageWidth || configOpts.svgImageWidth || 64;
        const svgImageSpace = cliOpts.svgImageSpace ||
