...
export function createSVG(data, ghsOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(data.map(({ login, avatarUrl, url }, index) => __awaiter(this, void 0, void 0, function* () {
            ...
            const avatar = yield getAvatar(avatarUrl, avatarCache, imageFormat);
            defs.push(`    <clipPath id="clip-${index}">
      <circle cx="${locationX + radius}" cy="${locationY + radius}" r="${radius}"/>
    </clipPath>`);
            images.push(`  <a xlink:href="${url}" class="sponsor-svg" target="_blank" id="${login}">
...
export function getAvatar(avatarUrl, avatarCache, format) {
    return __awaiter(this, void 0, void 0, function* () {
        function getBase64Image(data, format) {
