...
export function createSVG(data, ghsOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const imageSpacing = ghsOptions.svgImageSpace;
        const tileSize = imageWidth + imageSpacing;
        const rows = Math.max(1, Math.floor(svgWidth / tileSize));
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="${svgWidth}" height="${Math.ceil(data.length / rows) * tileSize}">
  <defs>
